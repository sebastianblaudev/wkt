...
<style>body{background:#0b0b0c;color:#fff;font-family:system-ui,sans-serif;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;margin:0;text-align:center;padding:20px}button{background:#50E3C2;color:#000;border:none;border-radius:8px;padding:14px 20px;font-size:16px;font-weight:600;margin:8px;cursor:pointer}a{color:#50E3C2}p{font-size:13px;color:#888}</style>
</head><body>
...
<p>Si la app no está instalada, <a href="${webUrl}">únete desde el navegador</a>.</p>
</body></html>`);
});
